...
<h2 style="text-align:center; margin-top: 50px;">Packages that I provide.</h2>
...
<div class="container">
	<div class="columns">
	  <ul class="price">
	    ...
	    <li class="grey"><a href="{{ url('contact') }}" class="button">Contact for this..</a></li>
	  </ul>
	</div>
	...
	<div class="columns">
	  <ul class="price">
	    ...
	    <li class="grey"><a href="#" class="button">Contact for this..</a></li>
	  </ul>
	</div>
