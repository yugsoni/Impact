...
<head>
	...
	<title> {{ request()->is('/', 'home') ? 'Impact' : '' }} {{ request()->is('about') ? 'About' : '' }} {{ request()->is('service') ? 'Service' : '' }} {{ request()->is('portfolio') ? 'Portfolio' : '' }} {{ request()->is('blog') ? 'Blog' : '' }} {{ request()->is('templates') ? 'Templates' : '' }} {{ request()->is('pakage') ? 'Packages' : '' }} {{ request()->is('contact') ? 'Contact' : '' }} </title>
	<!-- Bootstrap CSS -->
...
<body>
  ...
  <div id="status"></div>
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand logo_h" href="{{ url('../home') }}"><img src="img/svg/earth.svg"></a>
    ...
    @if($slug_url != '/home' && $slug_url != '/templates' && $slug_url != '/' )
    <section class="banner_area">
        <div class="banner_inner d-flex align-items-center">
            <div class="container">
                <div class="banner_content text-center">
                    <h2>{{ request()->is('about') ? 'About' : '' }} {{ request()->is('service') ? 'Service' : '' }} {{ request()->is('portfolio') ? 'Portfolio' : '' }} {{ request()->is('blog') ? 'Blog' : '' }} {{ request()->is('templates') ? 'Templates' : '' }} {{ request()->is('pakage') ? 'Packages' : '' }} {{ request()->is('contact') ? 'Contact' : '' }}</h2>
                    <div class="page_link">
                        <a href="{{ url('/home') }}">Home</a>
                        <a href=" {{ request()->is('about') ? url('/about') : '' }} {{ request()->is('service') ? url('/service') : '' }} {{ request()->is('portfolio') ? url('/Portfolio') : '' }} {{ request()->is('blog') ? url('/blog') : '' }} {{ request()->is('pakage') ? url('/pakage') : '' }} {{ request()->is('contact') ? url('/contact') : '' }} ">{{ request()->is('about') ? 'About' : '' }} {{ request()->is('service') ? 'Services' : '' }} {{ request()->is('portfolio') ? 'Portfolio' : '' }} {{ request()->is('blog') ? 'Blog' : '' }} {{ request()->is('pakage') ? 'Packages' : '' }} {{ request()->is('contact') ? 'Contact' : '' }}</a>
                    </div>
                </div>
            </div>
        </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | with <i class="fa fa-heart-o" style="color: #854fee;" aria-hidden="true"> by Impact Corporation</i> 
